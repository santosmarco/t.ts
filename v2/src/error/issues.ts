...
export namespace TIssue {
  export namespace Base {
    ...
    export type InvalidType = MakeTIssue<TIssueKind.Base.InvalidType, { expected: _.ValueKind; received: _.ValueKind }>

    export type Forbidden = MakeTIssue<TIssueKind.Base.Forbidden, { types?: _.ValueKind[] }>
  }
}
